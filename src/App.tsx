            ...
            <div id="hero-view" className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center text-center lg:text-left max-w-7xl mx-auto animate-slide-up py-2 md:py-4 w-full">
              ...
              <div className="lg:col-span-5 flex flex-col gap-6 w-full max-w-md mx-auto">
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-5 w-full">
                    {/* Left Column: Photo & LinkedIn Button */}
                    <div className="flex flex-col items-center shrink-0">
                      {/* Developer Photo */}
                      <div className="relative w-28 h-28 md:w-32 md:h-32 rounded-2xl overflow-hidden border border-cyan-500/25 dark:border-cyan-500/20 shadow-lg shadow-cyan-500/5 group/photo select-none">
                        <img
                          src="/satyajit.png"
                              ...
                              className={`px-2.5 py-1 rounded-md text-[10px] font-extrabold uppercase tracking-tight border ${
                                isDarkMode
                                  ? skill === "And many more..."
                                    ...
                                    : "bg-slate-900/60 border-white/5 hover:border-cyan-500/30 text-cyan-400"
                                  : skill === "And many more..."
                                    ? "bg-purple-50 border-purple-200 text-purple-600"
                                    : "bg-slate-50 border-slate-200 hover:border-indigo-400 text-indigo-600"
                              }`}
                            >
                              {skill}
                            </span>
